...
var url='mongodb://Santo:umkc@ds057386.mlab.com:57386/apldemo';//1.Modify this url with the credentials of your db name and password.
...
app.get('/update/:s_id', function (req, res) {
    MongoClient.connect(url, function(err, db) {
        ...
        if(req.query.GradeMath){
            newData.GradeMath = req.query.GradeMath;
        }
        if(req.query.GradeScience){
            newData.GradeScience = req.query.GradeScience;
        }
