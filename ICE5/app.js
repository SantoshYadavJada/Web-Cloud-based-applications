            ...
            if (venueSelected != null) {
                ...
                handler.success(function (result) {
                    if (result != null && result.response != null && result.response.tips != null &&
                        ...
                        var callback = $http.get("https://gateway-a.watsonplatform.net/calls/text/TextGetTextSentiment?" +
                            "apikey=d0e7bf68cdda677938e6c186eaf2b755ef737cd8&outputMode=json" +
                            "&text=" + $scope.mostRecentReview.text);
